...
currentFrame=0
# get video path
vidPath = './demoVideos/K-Fee_Auto_Commercial.mp4'

# start the webcam feed
# Display the video
vid = cv2.VideoCapture(vidPath)
# Get video audio path
musicPath = './demoVideos/K-Fee_Auto_Commercial.mp3'
...
print(writeto_file.writeto_file(emotionData))
